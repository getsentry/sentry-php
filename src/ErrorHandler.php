...
{
    /**
     * @var callable Exception callback
     */
    private $callback;
     ...
     * Constructor.
     *
     * @param callable $callback           The callback that will be invoked when an excpetion is caught
     * @param int      $reservedMemorySize The amount of memory to reserve for the fatal error handler
     */
    public function __construct(callable $callback, $reservedMemorySize = 10240)
    {
