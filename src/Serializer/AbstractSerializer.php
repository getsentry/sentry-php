...
abstract class AbstractSerializer
{
        ...
        if ($_depth < $max_depth) {
            ...
            if (\is_array($value)) {
                ...
                foreach ($value as $k => $v) {
                    $new[$this->serializeValue($k)] = $this->serializeRecursively($v, $max_depth, $_depth + 1);
                }
     ...
     */
    protected function serializeObject($object, $max_depth = 3, $_depth = 0, $hashes = [])
    {
        ...
        foreach ($object as $key => &$value) {
            if (\is_object($value)) {
                ...
                $new_value = $this->serializeRecursively($value, $max_depth, $_depth + 1);
            }
     ...
     * @param bool $value
     */
    public function setAllObjectSerialize(bool $value)
    {
