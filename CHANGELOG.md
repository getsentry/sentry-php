...
- StacktraceBuilder is no longer marked @internal, and a new public method Client::getStacktraceBuilder() allows custom stacktraces to be built and added to events.
